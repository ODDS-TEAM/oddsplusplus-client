                ...
                <div class="row" style="margin-top:5px;border-top:2px solid #efefef;">
                    ...
                    <div class="col-8 col-s-8">
                        ...
                        <table class="table-add-img">
                            ...
                            <tr>
                                <td><input id="modal-book-date" :min="minDateToday" type="date" v-model="date" />
                                </td>
                            </tr>
    
                        </table>
                        <p style="padding:10px;margin:0;text-align:center;"><button id="modal-save-button" class="button-add main-color" v-on:click="save">Add</button></p>
